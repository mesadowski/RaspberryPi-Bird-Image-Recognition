...
IMAGE_WIDTH = 3280           # Default= 1024 Full Size Image Width in px
IMAGE_HEIGHT = 2464           # Default= 768  Full Size Image Height in px
...
IMAGE_VFLIP = False           # Default= False True Flips image Vertically
IMAGE_HFLIP = False           # Default= False True Flips image Horizontally
...
# -------------------------------------
NIGHT_TWILIGHT_MODE_ON = False # Default= True Outside Lighting  False= Inside with No Twilight Lighting (reduce over exposures)
...
MOTION_TRACK_TIMEOUT_SEC = 2.0 # Default= 0.3 seconds Resets Track if no movement tracked
MOTION_TRACK_TRIG_LEN = 110     # Default= 75 px Length of motion track to Trigger motionFound
MOTION_TRACK_MIN_AREA = 110    # Default= 100 sq px  Minimum Area required to start tracking
...
web_page_refresh_sec = "60"  # Default= "900" seconds to wait for web page refresh  seconds (15 minutes)
